...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/Dqf3Si0Dlw)
...
```sh
npx nx serve todolist
```

To create a production bundle:

```sh
npx nx build todolist
```

To see all available targets to run for a project, run:

```sh
npx nx show project todolist
```
